...
class Trainer(object):
    ...
    def evaluate(self, mode):
        ...
        # 0327 新增
        precision = precision_score(out_label_ids.tolist(), preds.tolist(),
                                    average='macro', zero_division=0)
        recall = recall_score(out_label_ids.tolist(), preds.tolist(),
                              average='macro', zero_division=0)
        f1 = f1_score(out_label_ids.tolist(), preds.tolist(),
                      average='macro', zero_division=0)
        ...
        # 新增每一个label的prf
        logger.info(classification_report(out_label_ids.tolist(),
                                          preds.tolist(),
